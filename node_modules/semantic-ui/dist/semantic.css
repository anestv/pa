@import 'https://fonts.googleapis.com/css?family=Open+Sans|Damion|Comfortaa:400,700&subset=latin,greek';
...
body {
  ...
  padding: 0px;
  min-width: 278px;
  background: #157cbd -webkit-linear-gradient(top, #178bd4, #126da6) fixed;
  background: #157cbd linear-gradient(to bottom, #178bd4, #126da6) fixed;
...
::-webkit-selection {
  background-color: rgba(23, 139, 212, 0.5);
  color: rgba(0, 0, 0, 0.8);
}
...
.ui.basic.blue.button:hover {
  background: transparent !important;
  box-shadow: 0px 0px 0px 2px #1894e2 inset !important;
  color: #1894e2 !important;
}

.ui.basic.blue.buttons .button:active,
.ui.basic.blue.button:active {
  box-shadow: 0px 0px 0px 2px #1476b4 inset !important;
  color: #1476b4 !important;
}
...
.ui.basic.orange.button:hover {
  background: transparent !important;
  box-shadow: 0px 0px 0px 2px #f8a026 inset !important;
  color: #f8a026 !important;
}

.ui.basic.orange.buttons .button:active,
.ui.basic.orange.button:active {
  box-shadow: 0px 0px 0px 2px #e48807 inset !important;
  color: #e48807 !important;
}
...
.ui.inverted.orange.button {
  background-color: transparent;
  box-shadow: 0px 0px 0px 2px #f2a944 inset !important;
  color: #f2a944;
}
...
.ui.inverted.orange.button:active {
  box-shadow: 0px 0px 0px 2px #f09a23 inset !important;
...
.ui.blue.dividing.header {
  border-bottom: 2px solid #178bd4;
}
...
.ui.orange.dividing.header {
  border-bottom: 2px solid #f89a17;
}
...
i.inverted.circular.blue.icon {
  background-color: #178bd4 !important;
  color: #FFFFFF !important;
}
...
i.inverted.circular.orange.icon {
  background-color: #f89a17 !important;
  color: #FFFFFF !important;
}
...
a.ui.orange.label:hover {
  background-color: #f8a026 !important;
  border-color: #f8a026 !important;
  color: #ffffff !important;
}
